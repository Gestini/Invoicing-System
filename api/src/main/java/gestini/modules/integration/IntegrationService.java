...
import gestini.modules.integration.repositories.BusinessUnitIntegrationRepository;
import gestini.modules.integration.repositories.IntegrationRepository;
...
public class IntegrationService {
    ...
    public void createIntegration(CreateIntegrationRequestDto createRequest) {
    ...
    public void updateIntegrationConfig(Long businessUnitId, IntegrationConfigRequestDto configRequest) {
        BusinessUnitIntegrationModel integrationModel = businessUnitIntegrationRepository
    ...
    public IntegrationConfigResponseDto getIntegrationConfigForBusinessUnit(Long businessUnitId, Long integrationId) {
        BusinessUnitIntegrationModel integrationModel = businessUnitIntegrationRepository
                .findByBusinessUnitIdAndIntegrationId(businessUnitId, integrationId)
                .orElse(null);
        ...
        return new IntegrationConfigResponseDto(integrationModel.getEnabled(), configDataMap);
    }
