package gestini.modules.invitation.models;
...
@Entity
@Table(name = "business_unit_invitation", uniqueConstraints = { @UniqueConstraint(columnNames = { "token" }) })
public class BusinessUnitInvitationModel {
    @Id
