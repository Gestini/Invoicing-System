...
import productar.services.BusinessUnitInventoryService;

@RestController
@RequestMapping("/inventory")
public class BusinessUnitInventoryController {

    @Autowired
    private BusinessUnitInventoryService businessUnitInventoryService;

    @PostMapping("/asing-product-to-inventory")
    public ResponseEntity<?> asingProductToInventory(@RequestBody InventoryRequest data) {
