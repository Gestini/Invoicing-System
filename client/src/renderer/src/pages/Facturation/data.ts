...
export const factura = [
    {
        ...
        info: [
            { name: 'billType', title: 'Tipo de factura', value: '', type: 'select', options: [1, 6, 11], invisible: true },
            { name: 'billTypeLetter', title: 'Letra de la factura', value: '', type: 'select', options: ['A', 'B', 'C'] },
