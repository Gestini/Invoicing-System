...
const BulkUploadVanilla = () => {
  ...
  return (
    <div className='bg-c-sidebar-bg w-full h-full rounded-3xl shadow-lg flex'>
      {/* Si no hay productos, mostrar la sección de drag-and-drop */}
      {products.length === 0 ? (
        <div className='py-5 px-5 flex justify-between gap-4 w-full'>
          <ScrollShadow className='w-1/2'>
            <div className=''>
              <h2 className='text-2xl font-bold mb-4 text-c-title'>
                Instrucciones para Subida Masiva de Productos
              </h2>
              <h3 className='text-xl font-semibold mb-3 text-c-title'>Paso 1: Descarga</h3>
              ...
              <h3 className='text-xl font-semibold mb-3 text-c-title'>Paso 2: Subida de Archivo</h3>
              <p className='text-sm text-gray-500 mb-4'>Una vez rellenado el archivo:</p>
              <ul className='list-disc list-inside text-sm text-gray-400 mb-4'>
                <li>
              ...
              <h3 className='text-xl font-semibold mb-3 text-c-title'>
                Paso 3: Edición de Productos
              </h3>
              <p className='text-sm text-gray-500 mb-4'>Una vez cargado el documento, podrás:</p>
              <ul className='list-disc list-inside text-sm text-gray-400 mb-4'>
                <li>
              ...
              <h3 className='text-xl font-semibold mb-3 text-c-title'>Paso 4: Guardar Productos</h3>
              <p className='text-sm text-gray-500 mb-4'>Cuando esté listo:</p>
              <ul className='list-disc list-inside text-sm text-gray-400 mb-4'>
                <li>
          ...
          <div
            className='flex-grow flex flex-col justify-center items-center relative' // Añadimos "relative" para poder usar "absolute" en el overlay
            onDrop={handleDrop}
          ...
          >
            ...
            <div className='z-0 flex flex-col  items-center '>
              ...
              <span className='text-[12px] block text-c-title font-semibold mb-4 mt-4'>
                <a
