      ...
      <div className="formlogin w-[55%] h-[100vh] bg-white flex justify-center">
        <div className=" flex flex-col w-[420px]  ">
          ...
          <div className="titleform flex flex-col mb-[36px] mt-[14vh] ">
            <h3 className=" text-[36px] font-[700] mb-[10px] ">Sign In</h3>
            <p className=" text-[#A0AEC0] ">Enter your email and password to sign in!</p>
          </div>
          ...
          <div className=" flex  items-center gap-2 justify-start max-w-full ">
            <p className=" font-[400] text-[14px]  ">Not registered yet?</p>
            <a href="/#/register">
              <span className="text-[#422afb] font-[500] ">Create an Account</span>
            </a>
          </div>
        </div>
      </div>
