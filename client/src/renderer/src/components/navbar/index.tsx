              ...
              <div className='flex space-x-4'>
                {pathList.map((item, index) => (
                  <NavLink
                    ...
                    className={({ isActive }) =>
                      `text-gray-600 hover:bg-c-primary-route-hover hover:text-white transition-all duration-300 px-3 py-2 rounded-md text-sm font-medium ${
                        isActive || (item.name === 'Dashboard' && isDashboardActive)
                          ? 'bg-c-primary-route-active hover:bg-c-primary-route-active text-white'
                          : ''
                      }`
                    }
                  >
